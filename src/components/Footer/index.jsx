    ...
    <div className="px-4 md:px-24 bg-gray-800 text-white py-8">
      <div className="grid grid-cols-1 md:grid-cols-12">
        <div className="md:col-span-4 flex flex-col items-center md:items-start mb-2">
          ...
          <div className="mt-2 md:mt-10 text-sm text-gray-300">
            Copyright © 2021, STONE
          </div>
        </div>
        <div className="md:col-span-4 flex flex-col items-center md:items-start">
          ...
          <div className="flex flex-col mb-2 text-sm">
            <a
              className="text-center md:text-left mb-1 text-gray-300 hover:text-from"
              href="https://twitter.com/DefiStone"
              target="_blank"
              rel="noreferrer"
            >
              外链服务
            ...
            <a
              className="text-center md:text-left mb-1 text-gray-300 hover:text-from"
              href="https://discord.com/invite/MyYqNBF8TP"
              target="_blank"
              rel="noreferrer"
            >
              咨询服务
